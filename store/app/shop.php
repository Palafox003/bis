...
if(!isset($_SESSION["online"])){
	echo "<script>alert('You need to be Login!!'); location.href='../';</script>";
	exit;
}
if($_SESSION["online"]!="palafox@gmail.com"){
	echo "<script>alert('You need to be Admin!!'); location.href='../';</script>";
	exit;
}
?>
<!DOCTYPE html>
