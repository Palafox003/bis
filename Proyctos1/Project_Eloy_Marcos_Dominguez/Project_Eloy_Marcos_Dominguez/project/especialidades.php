...
<div class="container">
	<div class="row">
		...
		<div class="col">
			<img src="img/d.jpg" title="Piña rellena de mariscos." class="img-fluid img-gallery" desc="$200.00">
		</div>
		<div class="col">
			<img src="img/12.jpg" title="Brochetas de camarón."  class="img-fluid img-gallery" desc="$170.00">
		</div>
	</div>
</div>
<br><br>
