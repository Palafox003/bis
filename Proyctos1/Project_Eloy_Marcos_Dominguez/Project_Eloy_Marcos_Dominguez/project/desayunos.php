...
<h1>Explore our breakfasts!</h1>

<div class="container">
	<div class="row">
		<div class="col">
			<img src="img/hotca.jpg" title="Hot cakes con miel, jugo y café."  class="img-fluid img-gallery" desc="$30.00"> 
		</div>
		<div class="col">
			<img src="img/d.jpg" title="Huevos revueltos, estrellados, a la mexicana o carnes frias, jugo y cafe." class="img-fluid img-gallery" desc="$38.00">
		</div>
		<div class="col">
			<img src="img/12.jpg" title="Bistec con enchiladas o chilaquiles rojos o verdes con frijoles, jugo y cafe."  class="img-fluid img-gallery" desc="$60">
		</div>
	</div>
</div>
<br><br>
<div class="container">
	<div class="row">
		<div class="col">
			<img src="img/hotca.jpg" title="Sopes con huevo revuelto o estrellado, jugo y café."  class="img-fluid img-gallery" desc="$48.00"> 
		</div>
		<div class="col">
			<img src="img/d.jpg" title="Huevos rancheros o divorciados, frijoles, tortillas y café." class="img-fluid img-gallery" desc="$38.00">
		</div>
		<div class="col">
			<img src="img/12.jpg" title="Costel de frutas con miel, jugo y café."  class="img-fluid img-gallery" desc="$35.00">
		</div>
	</div>
</div>
<br><br>
