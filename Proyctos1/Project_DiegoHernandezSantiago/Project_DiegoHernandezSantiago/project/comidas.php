...
<div class="container">
	<div class="row">
		<div class="col">
			<img src="img/camarones.jpg" title="MENÚ OLÍMPICO"  class="img-fluid img-gallery" desc="Caldo de pescado, camarones al mojo de ajo o a la diabla, arroz casero, ensalada, frijoles y tortillas. $85.00"> 
		</div>
		<div class="col">
			<img src="img/d.jpg" title="MENÚ TECOLUTEÑO" class="img-fluid img-gallery" desc="">
		</div>
		<div class="col">
			<img src="img/12.jpg" title="MENÚ MARINERO"  class="img-fluid img-gallery" desc="">
		</div>
	</div>
</div>
<br><br>
<div class="container">
	<div class="row">
		<div class="col">
			<img src="img/hotca.jpg" title="MENÚ MARINERO"  class="img-fluid img-gallery" desc=""> 
		</div>
		<div class="col">
			<img src="img/d.jpg" title="MENÚ TÍPICO" class="img-fluid img-gallery" desc="">
		</div>
		<div class="col">
			<img src="img/12.jpg" title="MENÚ INFANTIL"  class="img-fluid img-gallery" desc="">
		</div>
	</div>
</div>
<br><br>
